...
# NOTE
# labor-raw.csv is raw data downloaded from Bureau of Labor Statistics (BLS). 
# labor-id.csv is a file I generated myself, where I looked up the SeriesID and added notes on relevant aspects of each Series ID.
# This script combines the two into a labor.csv file that I will work with in other python scripts. 
